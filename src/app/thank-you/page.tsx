...
const ThankYouPage = async ({ searchParams }: Props) => {
  ...
  return (
    <main className="relative lg:min-h-full">
      ...
      lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24"
      >
        <div className="lg:col-start-2">
          ...
          <div className="mt-16 text-sm font-medium">
                    ...
                    <div className="relative h-24 w-24">
                      {typeof image !== "string" && image.url ? (
                        <Image
                          ...
                          fill
                          className="object-cover object-center flex-none bg-gray-100 rounded-md"
                        />
                      ) : null}
                    </div>
            ...
            <PaymentStatus
              orderEamil={(order.user as User).email}
              orderId={order.id}
