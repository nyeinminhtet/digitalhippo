...
var authSchema_1 = require("../lib/authSchema");
...
exports.authRouter = (0, trpc_1.router)({
    createPayloadUser: trpc_1.publicProcedure
        .input(authSchema_1.SignUpSchema)
        .mutation(function (_a) {
        var input = _a.input;
        return __awaiter(void 0, void 0, void 0, function () {
            var email, password, payload, users, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5:
                        error_1 = _b.sent();
                        console.error("Error in createPayloadUser:", error_1);
                        throw new server_1.TRPCError({ code: "BAD_REQUEST", message: error_1.message });
